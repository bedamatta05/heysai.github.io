    ...
    <div className="container-fluid">
      <div className="about container">
        ...
        <div className="description">
          ...
          with 8.75 cgpa. And currently working as a Full Stack developer in
          Cognizant. When I'm not drawing, creating web-pages, and doing all my
          design-related interests, you'll find me outside with my friends in a
          calm place, reading science fiction/non-fiction, making memes,
          managing social-media pages and drinking as much tea as physically
          possible.
        </div>
        <SkillSet />
      </div>
